...
namespace UQLT.Helpers
{
    ...
    public class TextBoxFilters : Behavior<Control>
    {
        ...
        /// <param name="e"></param>
        private static void Filter_AlphabetsOnly(object sender, KeyEventArgs e)
        {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private static void Filter_AlphabetsUPPERCaseOnly(object sender, KeyEventArgs e)
        {
            var allAlphabets = new List<string>("q,w,e,r,t,y,u,i,o,p,a,s,d,f,g,h,j,k,l,z,x,c,v,b,n,m,Q,W,E,R,T,Y,U,I,O,P,A,S,D,F,G,H,J,K,L,Z,X,C,V,B,N,M,Space".Split(','));
            if (!allAlphabets.Contains(e.Key.ToString()))
            {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private static void Filter_AlphabetsUPPERCaseOnly(object sender, TextChangedEventArgs e)
        {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private static void Filter_Date(object sender, KeyEventArgs e)
        {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private static void Filter_Decimal(object sender, KeyEventArgs e)
        {
            bool shiftKeyPressd = (Keyboard.Modifiers & ModifierKeys.Shift) != 0;
            if (!((e.Key >= Key.D0 && e.Key <= Key.D9 && !shiftKeyPressd)))
            {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private static void Filter_IntegersOnly(object sender, KeyEventArgs e)
        {
            bool shiftKeyPressd = (Keyboard.Modifiers & ModifierKeys.Shift) != 0;
            if (!((e.Key >= Key.D0 && e.Key <= Key.D9 && !shiftKeyPressd)))
            {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private static void Filter_PositiveDecimal(object sender, KeyEventArgs e)
        {
            bool shiftKeyPressd = (Keyboard.Modifiers & ModifierKeys.Shift) != 0;
            if (!((e.Key >= Key.D0 && e.Key <= Key.D9 && !shiftKeyPressd)))
            {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private static void Filter_PositiveInteger(object sender, KeyEventArgs e)
        {
            bool shiftKeyPressd = (Keyboard.Modifiers & ModifierKeys.Shift) != 0;
            if (!(e.Key >= Key.D0 && e.Key <= Key.D9 && !shiftKeyPressd))
            {
