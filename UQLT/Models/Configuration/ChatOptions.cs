...
namespace UQLT.Models.Configuration
{
    ...
    public class ChatOptions
    {
        ...
        /// </summary>
        /// <value>
        ///   <c>true</c> if chat history is enabled otherwise, <c>false</c>.
        /// </value>
        ...
        /// </summary>
        /// <value>
        ///   <c>true</c> if chat sound is enabled otherwise, <c>false</c>.
        /// </value>
        
        public bool chat_sound { get; set; }
        /// <summary>
        /// Gets or sets a value indicating whether the user has allowed/disallowed UQLT to handle incoming chat messages when user is in game.
        /// </summary>
        /// <value>
        ///   <c>true</c> if UQLT handles in-game chat messages, otherwise, <c>false</c>.
        /// </value>
